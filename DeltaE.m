...
try
	...
	set(gcf,'name','Color Matching Demo','numbertitle','off') 
...
try
	...
	caption = sprintf('Left click and hold to begin drawing. Simply lift the mouse button to finish');
% 	text(10, 40, message, 'color', 'r', 'FontSize', fontSize, 'FontWeight', 'bold');
